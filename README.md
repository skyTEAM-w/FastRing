...
- [FastRing - 高性能ADC数据采集与传输系统](#fastring---高性能adc数据采集与传输系统)
  - [目录](#目录)
  - [核心特性](#核心特性)
  - [系统架构](#系统架构)
  - [快速开始](#快速开始)
    - [环境要求](#环境要求)
    - [编译](#编译)
      - [Windows (MinGW-w64 + Ninja)](#windows-mingw-w64--ninja)
...
- **v5.0** (2026-03-29) - 跨平台稳定性优化，4/4测试通过
  - 移除 CPU 绑定编译选项，提升可移植性
  - 改用 C11 `atomic_thread_fence`，增强跨平台兼容性
  - 修复网络模块 0 字节发送死循环问题
  - 新增 timestamp 测试
